...
class DispNetSTri(nn.Module):

    def __init__(self, nb_ref_imgs=2, alpha=10, beta=0.01):
        super(DispNetSTri, self).__init__()
        ...
        self.conv1 = downsample_conv(3*(1+self.nb_ref_imgs),              conv_planes[0], kernel_size=7)
    ...
    def forward(self, target_image, ref_imgs):
        ...
        out_upconv1 = crop_like(self.upconv1(out_iconv2), input)
        disp2_up = crop_like(F.interpolate(disp2, scale_factor=2, mode='bilinear', align_corners=False), input)
